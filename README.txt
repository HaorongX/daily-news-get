...
dng [opnion]
	...
	with arguments:
		...
		install [arguments]
			install a script
			for example:
			1. dng install name1 "/home/test.pl" "perl "
			2. dng install name2 "/home/test.py" "python "
			3. dng install name3 "/home/test/test.pl 10" "perl "
			Note:
		...
		update [arguments]
			update a script
			for exampe:
			1. dng update name  "/home/test.pl"
		open [name]
